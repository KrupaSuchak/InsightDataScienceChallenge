"""
Title: Venmo_Input Pipeline
Coder: Krupa Suchak
Function: Takes Venmo input as text data, converts to a default dictionary with a list, cleans data and unpredictable input, return rolling medium.
Created: 07/15/2016
